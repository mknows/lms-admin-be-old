...
route.get("/getReplyOfComment/:comment_id", protection, forumController.getReplyOnComment);

route.post("/makeDiscussionForum/", protection, forumController.postDiscussionForum);
